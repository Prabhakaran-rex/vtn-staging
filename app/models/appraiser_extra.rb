class AppraiserExtra < ActiveRecord::Base
  ...
  attr_accessible :affiliated_with, :bank_name, :bank_name_plain, :bank_routing_number, :bank_routing_number_plain, :certifications, :description, :signature_json, :uspap, :years_appraising, :website
